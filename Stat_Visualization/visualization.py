...
def create_plot(x_axis, data, y_label, path, title, y_unit=None, plot_type="plot"):
    y_axis = data
...
if __name__ == "__main__":
    ...
    create_plot(x, data["External Nutrition"], "External Nutrition", path, "External Nutrition", "mol")
    create_plot(x, data["Internal Nutrition"], "Internal Nutrition", path, "Internal Nutrition", "mol")
    create_plot(x, data["Internal Nutrition"]/hyphal_sum, "Average internal nutrition", path,
                "Average internal nutrition", "mol")

    create_plot(x, hyphal_sum, "Hyphal Cells", path, "Hyphal Cells")
    ...
    create_plot(x, hyphal_sum / data['Tip'], "HGU", path, "HGU", "μm")
